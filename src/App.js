...
const translations = {
  ru: {
    ...
    projects: {
      ...
      a73: { title: "Спортивный буклет FitZone", desc: "Печатная графика для фитнес-клуба." },
      a78: { title: "Шрифтовые пары", desc: "Задание на подбор шрифтовых пар" },
 a72: { title: "Логотип и иконки для космической станции 'Галактика'", desc: "Разработка фирменного стиля космической станции." },
  ...
  en: {
    ...
    projects: {
      ...
      a78: { title: "Font pairs", desc: "Font pairing task" },
...
{ id: 'f3', cat: "Веб-дизайн",       year: 2025, img: "images/избранное/1.png",            pdf: "images/избранное/mir/картина мира.pdf" },
 ...
 { id: 'a78', cat: "Айдентика", year: 2026, img: "images/shriftovye-pary/1.jpg", pdf: "images/shriftovye-pary/2.pdf" },
      ...
      { id: 'a67', cat: "Веб-дизайн",       year: 2025, img: "images/ямоидрузья/1.png",          pdf: "images/ямоидрузья/2.pdf" },
